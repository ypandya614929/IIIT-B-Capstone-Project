...
import bookmyconsultation.doctorservice.dto.ErrorDTO;
...
// for create doctor and retrieve doctor
@ControllerAdvice
public class MyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorDTO> handleInvalidBooking(DoctorNotFoundException e, WebRequest res){
        ErrorDTO errorDTO = new ErrorDTO();
