...
public class PrescriptionserviceRequestDTO {
    ...
    public PrescriptionserviceRequestDTO() {
    }

    public PrescriptionserviceRequestDTO(String id, String userId, String doctorId, String doctorName, String appointmentId, String diagnosis, List<HashMap<String, String>> medicineList) {
        this.id = id;
        this.userId = userId;
