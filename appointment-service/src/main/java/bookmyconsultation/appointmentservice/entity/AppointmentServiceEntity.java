...
//    @Column(name = "appointment_id")
    ...
    public AppointmentServiceEntity(String id, String appointmentDate, String createdDate, String doctorId, String priorMedicalHistory, String status, String symptoms, String timeSlot, String userId, String userEmailId, String userName, String doctorName) {
        this.id = id;
